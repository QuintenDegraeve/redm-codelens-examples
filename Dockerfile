...
RUN git clone https://github.com/QuintenDegraeve/redm-codelens-examples.git /home/example/project
...
# Install NodeJS
RUN git clone https://github.com/QuintenDegraeve/redm-codelens.git /tmp/redm-codelens
